...
public class RegisterActivity extends AppCompatActivity {
    Button bt_register;
    TextInputLayout til_name, til_username, til_password, til_confirmPass, til_mobile, til_email, til_age;
    ImageView iv_profile;
    String name, username, password, email, mobile, age, profile, confirm;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bt_register.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                age = til_age.getEditText().getText().toString();
                if (    //perform validation by calling all the validate functions inside the IF condition
                    ...
                    RegisterRequest registerRequest = new RegisterRequest(username, name, password, mobile, email, age, profile, new Response.Listener<String>() {
                        @Override
    ...
    private void initialize() {
        ...
        til_age = (TextInputLayout) findViewById(R.id.til_age_reg);
    ...
    private boolean validateAge(String string){
        if (string.equals("")){
            til_age.setError("Enter Your Age");
            return false;
